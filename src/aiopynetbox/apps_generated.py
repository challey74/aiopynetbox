...
class DcimApp(App):
    ...
    cooling_feeds: hints.DcimCoolingFeedsEndpoint
    cooling_intake_templates: hints.DcimCoolingIntakeTemplatesEndpoint
    cooling_intakes: hints.DcimCoolingIntakesEndpoint
    cooling_outflow_templates: hints.DcimCoolingOutflowTemplatesEndpoint
    cooling_outflows: hints.DcimCoolingOutflowsEndpoint
    cooling_sources: hints.DcimCoolingSourcesEndpoint
    ...
    module_bay_types: hints.DcimModuleBayTypesEndpoint
